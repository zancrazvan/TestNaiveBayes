 ...
 */
package com.varm.examples;

import com.varm.classifiers.NaiveBayes;
...
public class NaiveBayesExample {
	...
	public static void main(String[] args) throws IOException {
		...
		nb = new NaiveBayes(knowledgeBase);
		String exampleEn2 = "Hello World. I am a Naive Bayesian Network";
		String outputEn2 = nb.predict(exampleEn);
